...
class DrivingClient(DrivingController):
    ...
    def control_driving(self, car_controls, sensing_info):
        ...
        if sensing_info.speed > 180: set_throttle = 0.6  ## 최대속도를 80km/h로 설정
        ...
        if sensing_info.speed > 100: steer_factor = sensing_info.speed * 0.9
        ...
        for i in range(0, road_range):
            ...
            if fwd_angle > 80:  ## 커브가 45도 이상인 경우 brake, throttle 을 제어
                full_throttle = False
