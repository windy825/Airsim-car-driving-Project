...
- [주행 파트](#-----)
  ...
  * [1. 기본 제공 주행 코드](#1------------)
      ...
      - [3) 속도 제어](#3-------)
      - [4) 예외 상황 제어](#4----------)
  * [2. Way Points 기반 주행](#2-way-points------)
...
<img src="2. 주행 파트.assets/KakaoTalk_20220821_183401198.jpg" alt="KakaoTalk_20220821_183401198" style="zoom: 50%;" />

1. 차량의 중심, 차와 중앙선이 직각으로 만나는 점, 가장 가까이 있는 전방 way point, 총 세 점을 기반으로 삼각형을 만든다.

<br>

<img src="2. 주행 파트.assets/KakaoTalk_20220821_183401198_01.jpg" alt="KakaoTalk_20220821_183401198_01" style="zoom:50%;" />

2. 수평을 기준으로 하여, 총 180º에서 보정값 90º를 빼고, 추가로 현재 위치의 도로 커브 값과 다음 커브값의 차이를 구해서 뺀다. 제일 처음 기준으로는 angles[i] = 0이다. 이렇게 구한 값을 C라고 한다.

<br>

<img src="2. 주행 파트.assets/KakaoTalk_20220821_183401198_02.jpg" alt="KakaoTalk_20220821_183401198_02" style="zoom:50%;" />
...
<img src="2. 주행 파트.assets/KakaoTalk_20220821_183401198_03.jpg" alt="KakaoTalk_20220821_183401198_03" style="zoom:50%;" />

4. 삼각형의 모든 내각의 합이 180º임을 이용하여, 나머지 하나의 각을 구한다.

<br>

<img src="2. 주행 파트.assets/KakaoTalk_20220821_183401198_04.jpg" alt="KakaoTalk_20220821_183401198_04" style="zoom:50%;" />

5. 각 하나를 구했으면, 다음 way point를 기반으로 삼각형을 다시 그린다.

<br>

<img src="2. 주행 파트.assets/KakaoTalk_20220821_183401198_05.jpg" alt="KakaoTalk_20220821_183401198_05" style="zoom:50%;" />
...
<img src="2. 주행 파트.assets/KakaoTalk_20220821_183401198_06.jpg" alt="KakaoTalk_20220821_183401198_06" style="zoom:50%;" />

7. 모든 각을 구하면 위와 같이 내부의 α, β, γ 각을 전부 알 수 있다.

<br>

<img src="2. 주행 파트.assets/KakaoTalk_20220821_183401198_07.jpg" alt="KakaoTalk_20220821_183401198_07" style="zoom:50%;" />
